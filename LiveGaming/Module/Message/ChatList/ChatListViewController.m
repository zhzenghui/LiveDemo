...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    NSLog(@"-------%d",[[EaseMob sharedInstance].chatManager isLoggedIn]);
    [[EaseMob sharedInstance].chatManager loadAllConversationsFromDatabaseWithAppend2Chat:NO];
...
{
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, KSCREENWIDTH, KSCREENHEIHGT ) style:UITableViewStylePlain];
