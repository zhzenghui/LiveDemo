...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setTitleColor:KGrayText forState:UIControlStateSelected];
        [self setTitleColor:KGrayText forState:UIControlStateNormal];
...
//        [self setTitleColor:[z_UI colorWithHexString:@"#3D70E5"] forState:UIControlStateSelected];
//    }else{
//        [self setTitleColor:[z_UI colorWithHexString:@"#9B9B9B"] forState:UIControlStateNormal];
//    }
    if (self.selected) {
...
//    if (self.selected == YES) {
//        [self setTitleColor:[z_UI colorWithHexString:@"#3D70E5"] forState:UIControlStateNormal];
//    }else{
//        [self setTitleColor:[z_UI colorWithHexString:@"#9B9B9B"] forState:UIControlStateNormal];
//    }
...
-(void)setIsCancel:(BOOL)isCancel
{
    _isCancel = isCancel;
    if (isCancel == YES) {
        [self setImage:[UIImage imageNamed:@"cancel_02.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"cancel_01.png"] forState:UIControlStateSelected];
    }
}
