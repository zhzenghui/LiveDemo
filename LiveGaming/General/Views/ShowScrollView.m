...
@property (nonatomic,strong)IBJImageView * imageView;
...
- (instancetype)initWithFrame:(CGRect)frame andImage:(NSString *)image
{
    ...
    if (self) {
        ...
        _imageView=[[IBJImageView alloc]initWithImage:img];
        _imageView.frame=CGRectMake(0, 0, _size.width, _size.height);
